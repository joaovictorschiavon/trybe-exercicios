...
// notas refere-se ao aluno na posição 0 de alunos, aqui além de reduce será necessário utilizar também 
// a função map. Dica: Você pode acessar o index do array dentro de map, e você pode ver o objeto 
...
function studentAverage(students, grades) {
	const newArry = students.map((student, index) => ({
		name: student, 
...
// 					return acc += curr.reduce((acc2, curr2, index2, array2) => {
// 						return acc2 += Math.round(curr2/array2.length);
// 					});
// 			}),  
// 	}));